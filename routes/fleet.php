...
Route::get('tracking/provider', 'Resource\ProviderFleetResource@tracking_provider')->name('tracking.provider');

Route::get('request/ongoing/{id}', 'FleetController@ongoing')->name('ongoing'); 
