...
//Tickets insert data
Route::get('/insertTickets' , 'TicketController@insertData');
//Route::get('/insertTicketsData' , 'TicketController@insertTicketData');
Route::get('/insertTicketsDataNew' , 'TicketController@insertTicketData');
Route::get('/sendRequestTicket' , 'TicketController@send_request');
Route::get('/sendRequestsms' , 'TicketController@send_sms');
