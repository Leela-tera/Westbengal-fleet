...
if(env('IOS_USER_ENV')=='development'){
    ...
    $crt_provider_path=app_path().'/apns/provider/tranxit_provider_dev.pem';
}
else{
    $crt_user_path=app_path().'/apns/user/tranxit_user_live.pem';
    $crt_provider_path=app_path().'/apns/provider/tranxit_provider_live.pem';
}
