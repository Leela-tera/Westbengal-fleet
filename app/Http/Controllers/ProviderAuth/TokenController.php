...
class TokenController extends Controller
{
    ...
    public function districts() {
     ...
     /**
     * get the group of api wise data.
     *
     * 04/05/2021 added by Ashok.
     * @return \Illuminate\Http\Response
     */

    public function multiApiData(Request $request) {
            ...
            $temp['engineersList'] = $engineersList;
            $temp['zonalanddisrtictList'] = $zonalanddisrtictList;

             return response()->json(['message' => 'success','data'=>$temp,'status'=>1]);
