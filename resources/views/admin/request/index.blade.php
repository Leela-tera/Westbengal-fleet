        ...
        <div class="col-md-12" style="height:50px;color:red;">
            ...
            <table class="table table-striped table-bordered dataTable" id="table-4">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>@lang('admin.request.Ticket_ID')</th>
                ...
                @foreach($requests as $index => $request)
                    <tr>
                        ...
                        <td>
                            @if(in_array($request->status,['CANCELLED','COMPLETED','SCHEDULED','SEARCHING']))
                             --
                            @else 
                             <a href="{{url('admin/request/ongoing',$request->id)}}" class="btn btn-info">Ongoing </a>
                            @endif
