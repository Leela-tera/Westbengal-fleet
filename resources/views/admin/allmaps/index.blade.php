...
<script>
    ...
    function ajaxMapData() {
        map.clearOverlays();
        $.ajax({
            url: 'https://fleet.terasoftware.com/public/westbengal/public/admin/alltrackmap/ajax?district_id='+ districtdata+'&provider_id='+providerid +'&from_date='+fromdate+'&to_date='+todate,
            dataType: "JSON",
