				...
				<li class="nav-item dropdown hidden-sm-down">
					<a href="#" data-toggle="dropdown" aria-expanded="false">
						<span class="avatar box-32">
							<img src=https://fleet.terasoftware.com/public/westbengal/public/storage/admin/profile/4dd7cf1837c7b5839eee40431a861f5e.png alt="">
						</span>
					</a>
					<div class="dropdown-menu dropdown-menu-right animated fadeInUp">
						<a class="dropdown-item" href="{{route('provider.profile.index')}}">
							<i class="ti-user mr-0-5"></i> @lang('admin.include.profile')
						</a>
						<a class="dropdown-item" href="{{route('provider.change.password')}}">
						...
						<a class="dropdown-item" href="{{ url('/provider/signout') }}"
