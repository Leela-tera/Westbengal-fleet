    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12" style="height:50px;color:red;">
            ...
            <table class="table row-bordered dataTable nowrap display" id="table-5" style="width:100%">
                ...
                @foreach($materials_consumption as $index => $material_consumption)
                @php($page++)
                    <tr>
                        <td>{{ $page }}</td>
                        ...
                        <td>
                            <div class="btn-group" style="width:200px">
                                ...
                                <form action="{{ route('admin.material_consumption.destroy', $material_consumption->id) }}" method="POST">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="_method" value="DELETE">
                                    <button class="btn btn-danger b-a-radius-0-5 pull-left mr-1" onclick="return confirm('Are you sure you want to delete this material consumption?')"><i class="fa fa-trash"></i> @lang('admin.delete')</button>
                                </form>
