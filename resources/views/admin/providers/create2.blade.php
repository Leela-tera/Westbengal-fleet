    ...
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.provider.store')}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
					<label for="email" class="col-xs-12 col-form-label">Designation Type</label>
					<div class="col-xs-10">
				...
				<div class="form-group row">
					<label for="email" class="col-xs-12 col-form-label">Districts</label>
					<div class="col-xs-10">
                ...
                @if(count($blocks) > 0)
				<div class="form-group row">
					<label for="email" class="col-xs-12 col-form-label">Blocks</label>
					<div class="col-xs-10">
