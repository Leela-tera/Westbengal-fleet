...
<head>
    ...
    <title>{{ Setting::get('site_title','Trouble Ticket Monitoring System') }}</title>
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                ...
                                <li @if(Request::url() == url('/ride')) class="active" @endif>
                                    <a href="{{url('/ride')}}">DHQ/QCC</a>
                                </li>
                                <li @if(Request::url() == url('/drive')) class="active" @endif>
                                    <a href="{{url('/drive')}}">POP/FRT</a>
                                </li>
                                 <li><a href="{{ url('help') }}">Help</a></li>
                                  
                            </ul>
							
							<a class="nav navbar-nav navbar-right navbar-brand" href="{{url('/')}}"><img style="width:86px !important;" src="{{ asset('uploads/teralogo.png') }}"></a>
