...
<div class="row gray-section pad-60 full-section">
    <div class="container">                
        <div class="col-md-6 content-block">
            ...
            <a class="content-more more-btn" href="{{ url('/drive') }}">WHY DRIVE WITH {{ Setting::get('site_title', 'Tranxit')  }} <i class="fa fa-chevron-right"></i></a>
        </div>
