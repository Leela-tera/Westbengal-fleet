            ...
            <div class="col-md-4">
                <div class="banner-form">
                    <div class="row no-margin fields">
                        ...
                        <div class="right">
                            <a href="{{url('login')}}">
                                <h3>DHQ with {{Setting::get('site_title','Trouble Ticket Monitoring System')}}</h3>
    ...
    <div class="row white-section pad-60 no-margin">
        <div class="container ">
            ...
            <div class="col-md-4 content-block small">
                ...
                <p>{{ Setting::get('site_title', 'Trouble Ticket Monitoring System')  }} is the smartest way to get around. One tap and a car comes directly to you. Your driver knows exactly where to go. And you can pay with either cash or card.</p>
            </div>
        </div>
            ...
            <div class="col-md-4 content-block small">
                ...
                <div class="title-divider"></div>
                <p>When you arrive at your destination, either pay with cash or have your card automatically charged. With {{ Setting::get('site_title', 'Trouble Ticket Monitoring System') }}, the choice is yours.</p>
            </div>
        </div>
