...
<body class="fixed-sidebar fixed-header content-appear skin-default">
    ...
    <div class="wrapper">
        ...
        @include('provider.include.pnav')

        @include('provider.include.pheader')
        ...
        <div class="site-content">
            ...
            @include('provider.include.pfooter')
    ...
    <script type="text/javascript" src="{{asset('main/assets/js/ezoom.js')}}"></script>
