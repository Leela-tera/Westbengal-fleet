			...
			<ul class="nav navbar-nav float-md-right">
					...
					<div class="dropdown-menu dropdown-menu-right animated fadeInUp">
						<a class="dropdown-item" href="{{ route('admin.tickets.create') }}">
							<i class="ti-ticket mr-0-5"></i> Add New Ticket				</a>
						<div class="dropdown-divider"></div>
						<a class="dropdown-item" href="{{ route('admin.provider.create') }}">
							<i class="ti-layout-grid2-alt mr-0-5"></i> Add New Contact						</a>
					</div>
				</li>  
				<li class="nav-item dropdown hidden-sm-down">
					<a href="#" data-toggle="dropdown" aria-expanded="false">
						<span class="avatar box-32">
							<img src="{{ img(optional(Auth::guard('admin')->user())->picture ?? 'default-avatar.png') }}" alt="">
						</span>
					</a>
					<div class="dropdown-menu dropdown-menu-right animated fadeInUp">
