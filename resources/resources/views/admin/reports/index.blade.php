...
<div class="content-area py-1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <a href="/admin/tickets?zone_id={{ $user->zone_id }}&team_id={{ $user->team_id }}&status=NotStarted&from_date={{ $fromDate }}&to_date={{ $toDate }}">
                {{ $user->pending_tickets }}
            </a>
        @else
            <a href="/admin/tickets?zone_id={{ $user->zone_id }}&team_id={{ $user->team_id }}&status=NotStarted">
                {{ $user->pending_tickets }}
            </a>
        @endif
            </td>
