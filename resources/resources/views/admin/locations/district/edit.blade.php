...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;">@lang('admin.location.update_district')</h5>

      <form class="form-horizontal" action="{{route('admin.location.update', $district->id )}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
        	...
        	<div class="box-block">
					<div class="form-group row">
						<div class="col-sm-12 col-md-12">
							...
							<input class="form-control select-box" type="text" value="{{ $district->name }}" name="district_name" required id="district_name" placeholder="District Name">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-xs-12 mt-2">
							<button type="submit" class="btn btn-primary btn-cstm pull-right ">@lang('admin.location.update_district')</button>
