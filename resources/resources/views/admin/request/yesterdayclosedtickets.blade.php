                            ...
                            <td>
                                <div class="input-group-btn">
                                  ...
                                  <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{ route('admin.requests.show', $request->uid) }}" class="btn btn-default"><i class="fa fa-search"></i> More Details</a>
                                    </li>
                                     <?php if($request->ustatus == 'SEARCHING' || $request->ustatus == 'CANCELLED' ){ ?>
                                     <li>
...
@section('scripts')
 ...
 jQuery.fn.DataTable.Api.register( 'buttons.exportData()', function ( options ) {
   if ( this.context.length ) {
     ...
     var jsonResult = $.ajax({
       url: "{{url('admin/yesterdayclosed-tickets')}}"+string,
       data: {},
