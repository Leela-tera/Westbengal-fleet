        	...
        	<div class="box-block pb-0">
      		<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<input class="form-control select-box" type="date" name="date" id="date" placeholder="Date" value="{{ $inventory->date }}" onclick="this.showPicker()">
						</div>
					</div>
					...
					<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<select class="form-control select-box" name="district" id="district" required>
								...
								<option value="{{$dist->id}}" {{ $dist->id == $inventory->district_id ? 'selected' : '' }}>{{$dist->name}}</option>
								@endforeach									
							</select>
						</div>
					</div>
					...
					<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<input class="form-control select-box" type="text" value="{{ $inventory->opening_stock }}" name="opening_stock"  id="opening_stock" placeholder="Opening Stock">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<input class="form-control select-box" type="text" value="{{ $inventory->inward }}" name="inward"  id="inward" placeholder="Inward">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<input class="form-control select-box" type="text" value="{{ $inventory->issued_qty }}" name="issued_qty"  id="issued_qty" placeholder="Issued Quantity">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<input class="form-control select-box" type="text" value="{{ $inventory->mrn_qty }}" name="mrn_qty"  id="mrn_qty" placeholder="MRN Quantity">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<input class="form-control select-box" type="text" value="{{ $inventory->closing_stock }}" name="closing_stock"  id="closing_stock" placeholder="Closing Stock">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<input class="form-control select-box" type="text" value="{{ $inventory->comments }}" name="comments"  id="comments" placeholder="Remarks">
						</div>
					</div>
					<div class="form-group row">
