...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;">@lang('admin.equipment.update_equipment')</h5>
        	...
        	<div class="box-block pb-0">
					<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<input class="form-control select-box" type="text" value="{{ $equipment->name }}" name="equipment_name" required id="equipment_name" placeholder="Equipment Name">
						</div>
					</div>
					...
					<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<select class="form-control select-box" name="service_type" id="service_type" required>
								...
								<option value="{{$material->id}}" {{ $material->id == $equipment->service_type_id ? 'selected' : '' }}>{{$material->name}}</option>
								@endforeach									
							</select>
						</div>
					</div>
					...
					<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<select class="form-control select-box" name="current_assignee" id="current_assignee" >
								...
								<option value="{{$provider->id}}" {{ $provider->id == $equipment->provider_id ? 'selected' : '' }}>{{ $provider->first_name }} {{ $provider->last_name }}</option>
								@endforeach									
							</select>
						</div>
					</div>
					...
					<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<input class="form-control select-box" type="text" value="{{ $equipment->service_number }}" name="service_number"  id="service_number" placeholder="Service Number">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<input class="form-control select-box" type="text" value="{{ $equipment->service_model }}" name="service_model"  id="service_model" placeholder="Service Model">
						</div>
					</div>
					...
					<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<select class="form-control select-box" name="district" id="district" required>
								...
								<option value="{{$dist->id}}" {{ $dist->id == $equipment->district_id ? 'selected' : '' }}>{{$dist->name}}</option>
								@endforeach									
							</select>
						</div>
					</div>
			        ...
			        <div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<select class="form-control select-box" name="block" id="block" required>
								...
								<option value="{{$block->id}}" {{ $block->id == $equipment->block_id ? 'selected' : '' }}>{{$block->name}}</option>
								@endforeach									
							</select>
						</div>
					</div>
			        ...
			        <div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<select class="form-control select-box" name="status" id="status" required>
								...
								<option value="in-service" {{ $equipment->status == 'in-service' ? 'selected' : '' }}>In Service</option>
								<option value="out-of-service" {{ $equipment->status == 'out-of-service' ? 'selected' : '' }}>Out Of Service</option>
								<option value="missing" {{ $equipment->status == 'missing' ? 'selected' : '' }}>Missing</option>
							</select>
						</div>
					</div>
			</div>
        	...
        	<div class="box-block pb-0">
					<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<input class="form-control select-box" type="text" value="{{ $equipment->purchase_price }}" name="purchase_price"  id="purchase_price" placeholder="Purchase Price">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<input class="form-control select-box" type="date" name="purchase_date" id="purchase_date" value="{{ $equipment->purchase_date }}" placeholder="Purchase Date" onclick="this.showPicker()">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<input class="form-control select-box" type="date" name="warranty_exp_date" value="{{ $equipment->warranty_exp_date }}" id="warranty_exp_date" placeholder="Warranty Expiration Date" onclick="this.showPicker()">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-10 col-md-10">
							...
							<input class="form-control select-box" type="text" value="{{ $equipment->purchase_comments }}" name="purchase_comments"  id="purchase_comments" placeholder="Purchase Comments">
						</div>
					</div>
					<div class="form-group row">
						<label for="zipcode" class="col-xs-12 col-form-label"></label>
						<div class="col-xs-12 mt-2">
							<button type="submit" class="btn btn-primary btn-cstm pull-right ">@lang('admin.equipment.update_equipment')</button>
