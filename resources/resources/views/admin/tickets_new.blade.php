...
?>
      ...
      {{ $tickets->appends(['status' => @$status_get,'district_id'=>@$district_id_get,'searchinfo'=>@$serch_term_get,'zone_id'=>@$zone_id_get,'team_id'=>@$team_id_get,'block_id'=>@$block_id_get,'from_date'=>@$from_date_get,'to_date'=>@$to_date_get,'autoclose'=>@$autoclose_get,'default_autoclose'=>@$default_autoclose_get,'searchinfo'=>@$searchinfo_get,'category'=>@$category_get,'newfrom_date'=>@$newfrom_date_get,'newto_date'=>@$newto_date_get])->links()  }}
   </div>
@endsection
@section('scripts')
